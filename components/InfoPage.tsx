    ...
    <div className="max-w-3xl mx-auto px-5 pt-28 pb-20">
      ...
      <section className="mb-10">
        <div className="flex items-center gap-3 mb-4">
          ...
          >
            <Upload size={16} style={{ color: colors.green600 }} />
          </div>
          <h2 style={{ color: colors.green900, fontWeight: 600, fontSize: "1.25rem" }}>
        ...
        <div
          ...
          style={{ backgroundColor: colors.green50, border: `1px solid ${colors.green200}` }}
        >
          <p style={{ color: colors.gray700, lineHeight: "1.8", fontSize: "0.95rem" }}>
            Click the <strong style={{ color: colors.green900 }}>Submit Work</strong>  button in the
      ...
      <section>
        <div className="flex items-center gap-3 mb-4">
          <div
            ...
            style={{ backgroundColor: colors.green100 }}
          >
            <Shield size={16} style={{ color: colors.green600 }} />
          </div>
          <h2 style={{ color: colors.green900, fontWeight: 600, fontSize: "1.25rem" }}>
            A Few Ground Rules
          </h2>
