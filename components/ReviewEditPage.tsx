  ...
  if (!authorized) {
    return (
      <div className="max-w-sm mx-auto px-5 pt-32 pb-20 text-center">
        <div className="rounded-2xl border p-8" style={{ borderColor: colors.gray200, backgroundColor: colors.white }}>
          <div
          ...
          <h1 style={{ color: colors.green900, fontWeight: 700, fontSize: "1.25rem", marginBottom: "0.5rem" }}>
  ...
  return (
    <div className="max-w-3xl mx-auto px-5 pt-24 pb-16">
      ...
      <div className="flex flex-wrap items-center gap-x-3 gap-y-1 mb-5">
        <span style={{ color: colors.gray700, fontSize: "0.8rem", fontWeight: 500 }}>{submission.name}</span>
        <span style={{ color: colors.gray400, fontSize: "0.75rem" }}>·</span>
        <span style={{ color: colors.gray500, fontSize: "0.75rem" }}>{submission.studentCode}</span>
        <span style={{ color: colors.gray400, fontSize: "0.75rem" }}>·</span>
        <span style={{ color: colors.gray500, fontSize: "0.75rem" }}>{submission.grade}</span>
        <span
